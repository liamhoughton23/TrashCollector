...
namespace TrashWebsite.Controllers
{
    public class EmployeeModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ZipCode")] EmployeeModel employeeModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ZipCode")] EmployeeModel employeeModel)
        {
            if (ModelState.IsValid)
            {
